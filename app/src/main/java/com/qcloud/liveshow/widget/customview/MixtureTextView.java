...
public class MixtureTextView extends RelativeLayout {
    ...
    public MixtureTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //get text
        if (StringUtils.isNotEmptyString(mText)) {
    ...
    private void cacuLineHeight() {
        layout = new StaticLayout("AV8D", mTextPaint, 0, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0f, false);
