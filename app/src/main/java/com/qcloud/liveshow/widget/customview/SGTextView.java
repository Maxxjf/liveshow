...
/**
 * 类说明：自定义View 能加阴影，渐变等属性
 * Author: iceberg
 * Date: 2017/12/11.
 */
public class SGTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public void setStyle(String strokeColor, String startColor,
        ...
        setStyle(
                ...
                ResourceUtils.dip2px(getContext(), strokewidthDp),
                new LinearGradient(0, 0, 0, ResourceUtils.dip2px(getContext(),
